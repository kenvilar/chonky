 ...
 */
exports.thunkDispatchFileAction = function (data) { return function (dispatch, getState) {
 ...
 */
exports.thunkRequestFileAction = function (action, payload) { return function (dispatch, getState) {
...
exports.triggerDispatchAfterEffect = function (dispatch, data, effectResult) {
