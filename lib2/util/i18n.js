...
exports.getI18nId = function (namespace, stringId) {
    return "chonky." + namespace + "." + stringId;
};
exports.getActionI18nId = function (actionId, stringId) {
    return "chonky." + I18nNamespace.FileActions + "." + actionId + "." + stringId;
};
exports.useLocalizedFileActionGroup = function (groupName) {
...
exports.useLocalizedFileActionStrings = function (action) {
    var intl = react_intl_1.useIntl();
    return react_1.useMemo(function () {
        var _a, _b, _c;
        if (!action) {
...
exports.useLocalizedFileEntryStrings = function (file) {
    var intl = react_intl_1.useIntl();
