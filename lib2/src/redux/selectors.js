...
var selectFileActionData = function (fileActionId) { return function (state) {
    return (0, exports.selectFileActionMap)(state)[fileActionId];
}; };
...
var selectCurrentFolder = function (state) {
    var folderChain = (0, exports.selectFolderChain)(state);
...
var selectFileData = function (fileId) { return function (state) {
    return fileId ? (0, exports.selectFileMap)(state)[fileId] : null;
}; };
...
var selectHiddenFileCount = function (state) {
    return Object.keys((0, exports.selectHiddenFileIdMap)(state)).length;
};
...
var selectSelectedFileIds = function (state) {
    return Object.keys((0, exports.selectSelectionMap)(state));
};
exports.selectSelectedFileIds = selectSelectedFileIds;
var selectSelectionSize = function (state) {
    return (0, exports.selectSelectedFileIds)(state).length;
};
exports.selectSelectionSize = selectSelectionSize;
var selectIsFileSelected = function (fileId) { return function (state) {
    return !!fileId && !!(0, exports.selectSelectionMap)(state)[fileId];
}; };
exports.selectIsFileSelected = selectIsFileSelected;
var selectSelectedFiles = function (state) {
    var fileMap = (0, exports.selectFileMap)(state);
    return Object.keys((0, exports.selectSelectionMap)(state)).map(function (id) { return fileMap[id]; });
};
...
var selectSelectedFilesForAction = function (fileActionId) { return function (state) {
    ...
    if (!action || !action.requiresSelection)
        return undefined;
    return (0, exports.getSelectedFiles)(state, action.fileFilter);
}; };
exports.selectSelectedFilesForAction = selectSelectedFilesForAction;
var selectSelectedFilesForActionCount = function (fileActionId) { return function (state) { var _a; return (_a = (0, exports.getSelectedFilesForAction)(state, fileActionId)) === null || _a === void 0 ? void 0 : _a.length; }; };
...
var selectOptionValue = function (optionId) { return function (state) {
    return (0, exports.selectOptionMap)(state)[optionId];
}; };
...
var selectContextMenuTriggerFile = function (state) {
    var _a;
    var config = (0, exports.selectContextMenuConfig)(state);
...
var getIsFileSelected = function (state, file) {
    ...
    return !!(0, exports.selectSelectionMap)(state)[file.id];
};
...
var getSelectedFilesForAction = function (state, fileActionId) {
    return (0, exports.selectSelectedFilesForAction)(fileActionId)(state);
};
