...
var thunkUpdateRawFileActions = function (rawFileActions, disableDefaultFileActions) { return function (dispatch) {
    var _a = (0, files_transforms_1.sanitizeInputArray)('fileActions', rawFileActions), sanitizedArray = _a.sanitizedArray, errorMessages = _a.errorMessages;
    ...
    dispatch((0, exports.thunkUpdateToolbarNContextMenuItems)(fileActions));
    dispatch((0, files_thunks_1.thunkSortFiles)());
    dispatch((0, files_thunks_1.thunkUpdateHiddenFiles)());
    dispatch((0, files_thunks_1.thunkUpdateDisplayFiles)());
}; };
exports.thunkUpdateRawFileActions = thunkUpdateRawFileActions;
var thunkUpdateToolbarNContextMenuItems = function (fileActions) { return function (dispatch) {
...
exports.thunkUpdateToolbarNContextMenuItems = thunkUpdateToolbarNContextMenuItems;
var thunkUpdateDefaultFileViewActionId = function (fileActionId) { return function (dispatch, getState) {
...
exports.thunkUpdateDefaultFileViewActionId = thunkUpdateDefaultFileViewActionId;
var thunkActivateSortAction = function (fileActionId) { return function (dispatch, getState) {
    if (!fileActionId)
        return;
...
exports.thunkActivateSortAction = thunkActivateSortAction;
var thunkToggleOption = function (optionId) { return function (dispatch) {
...
exports.thunkToggleOption = thunkToggleOption;
var thunkApplySelectionTransform = function (action) { return function (dispatch, getState) {
    var selectionTransform = action.selectionTransform;
    if (!selectionTransform)
        return;
    var state = getState();
    var prevSelection = new Set(Object.keys((0, selectors_1.selectSelectionMap)(state)));
    var hiddenFileIds = new Set(Object.keys((0, selectors_1.selectHiddenFileIdMap)(state)));
    var newSelection = selectionTransform({
        prevSelection: prevSelection,
        fileIds: (0, selectors_1.selectCleanFileIds)(state),
        fileMap: (0, selectors_1.selectFileMap)(state),
...
exports.thunkApplySelectionTransform = thunkApplySelectionTransform;
