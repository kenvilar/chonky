...
exports.DefaultActions = {
     ...
     */
    OpenSelection: (0, helpers_1.defineFileAction)({
        id: 'open_selection',
        hotkeys: ['enter'],
        ...
        reduxDispatch((0, dispatchers_thunks_1.thunkRequestFileAction)(essential_1.EssentialActions.OpenFiles, {
     ...
     */
    SelectAllFiles: (0, helpers_1.defineFileAction)({
        id: 'select_all_files',
        hotkeys: ['ctrl+a'],
        button: {
     ...
     */
    ClearSelection: (0, helpers_1.defineFileAction)({
        id: 'clear_selection',
        hotkeys: ['escape'],
        button: {
     ...
     */
    EnableListView: (0, helpers_1.defineFileAction)({
        id: 'enable_list_view',
        fileViewConfig: {
     ...
     */
    EnableCompactView: (0, helpers_1.defineFileAction)({
     ...
     */
    EnableGridView: (0, helpers_1.defineFileAction)({
        id: 'enable_grid_view',
     ...
     */
    SortFilesByName: (0, helpers_1.defineFileAction)({
     ...
     */
    SortFilesBySize: (0, helpers_1.defineFileAction)({
     ...
     */
    SortFilesByDate: (0, helpers_1.defineFileAction)({
     ...
     */
    ToggleHiddenFiles: (0, helpers_1.defineFileAction)({
     ...
     */
    ToggleShowFoldersFirst: (0, helpers_1.defineFileAction)({
     ...
     */
    FocusSearchInput: (0, helpers_1.defineFileAction)({
        id: 'focus_search_input',
        hotkeys: ['ctrl+f'],
    }, function (_a) {
        var getReduxState = _a.getReduxState;
        var focusSearchInput = (0, selectors_1.selectFocusSearchInput)(getReduxState());
        if (focusSearchInput)
            focusSearchInput();
    }),
    /**
     * Action that enables List view.
     */
    ToggleDarkMode: (0, helpers_1.defineFileAction)({
        id: 'enable_dark_mode',
        option: {
            id: 'dark_mode',
            defaultValue: false,
