...
exports.ListEntry = react_1.default.memo(function (_a) {
    ...
    var styleState = (0, react_1.useMemo)(function () { return ({
        entryState: entryState,
        dndState: dndState,
    }); }, [dndState, entryState]);
    var classes = useStyles(styleState);
    var commonClasses = (0, GridEntryPreview_1.useCommonEntryStyles)(entryState);
...
var useStyles = (0, styles_1.makeLocalChonkyStyles)(function (theme) { return ({
    listFileEntry: {
        boxShadow: "inset ".concat(theme.palette.divider, " 0 -1px 0"),
