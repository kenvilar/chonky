...
var getGridConfig = function (width, fileCount, viewConfig, isMobileBreakpoint) {
    var gutter = isMobileBreakpoint ? 5 : 8;
    var scrollbar = (0, exports.isMobileDevice)() ? 0 : 18;
    var columnCount;
    var columnWidth;
...
exports.GridContainer = react_1.default.memo(function (props) {
    ...
    var fileCount = (0, react_1.useMemo)(function () { return displayFileIds.length; }, [displayFileIds]);
    var gridRef = (0, react_1.useRef)();
    var isMobileBreakpoint = (0, styles_1.useIsMobileBreakpoint)();
    ...
    var _a = (0, react_1.useState)((0, exports.getGridConfig)(width, fileCount, viewConfig, isMobileBreakpoint)), gridConfig = _a[0], setGridConfig = _a[1];
    var gridConfigRef = (0, react_1.useRef)(gridConfig);
    (0, react_1.useEffect)(function () {
        var oldConf = gridConfigRef.current;
        var newConf = (0, exports.getGridConfig)(width, fileCount, viewConfig, isMobileBreakpoint);
    ...
    var sizers = (0, react_1.useMemo)(function () {
    ...
    var getItemKey = (0, react_1.useCallback)(function (data) {
        var _a;
        var index = data.rowIndex * gridConfigRef.current.columnCount + data.columnIndex;
        return (_a = displayFileIdsRef.current[index]) !== null && _a !== void 0 ? _a : "loading-file-".concat(index);
    }, [gridConfigRef, displayFileIdsRef]);
    var cellRenderer = (0, react_1.useCallback)(function (data) {
        var gc = gridConfigRef;
    ...
    var gridComponent = (0, react_1.useMemo)(function () {
