...
exports.GridEntryPreviewFolder = react_1.default.memo(function (props) {
    ...
    var commonClasses = (0, exports.useCommonEntryStyles)(entryState);
    ...
    return (react_1.default.createElement("div", { className: className },
        react_1.default.createElement("div", { className: folderClasses.folderBackSideMid },
            ...
            react_1.default.createElement("div", { className: folderClasses.folderFrontSide },
                ...
                react_1.default.createElement("div", { className: (0, styles_1.c)([
...
var useFolderStyles = (0, styles_1.makeLocalChonkyStyles)(function (theme) { return ({
    previewFile: {
    ...
    folderBackSideTop: {
        ...
        boxShadow: function (state) {
            ...
            return "inset ".concat(color, " 0 0 0 999px");
        },
    ...
    folderFrontSide: {
        boxShadow: function (state) {
            ...
            shadows.push("inset ".concat(theme.gridFileEntry.folderFrontColorTint, " 0 0 0 999px"));
            return shadows.join(', ');
        },
        backgroundColor: function (state) { return state.color; },
        borderRadius: theme.gridFileEntry.borderRadius,
    ...
    fileIcon: {
        fontSize: (0, styles_1.important)(theme.gridFileEntry.childrenCountSize),
    },
}); });
...
var useFileStyles = (0, styles_1.makeLocalChonkyStyles)(function (theme) { return ({
    previewFile: {
        boxShadow: function (state) {
            var shadows = [];
            if (state.selected)
            ...
            if (state.focused)
                shadows.push('inset rgba(0, 0, 0, 1) 0 0 0 3px');
            shadows.push("inset ".concat(theme.gridFileEntry.fileColorTint, " 0 0 0 999px"));
            return shadows.join(', ');
        },
        backgroundColor: function (state) { return state.color; },
        borderRadius: theme.gridFileEntry.borderRadius,
...
exports.useCommonEntryStyles = (0, styles_1.makeLocalChonkyStyles)(function (theme) { return ({
    selectionIndicator: {
