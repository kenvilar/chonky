...
exports.DnDFileEntry = react_1.default.memo(function (_a) {
    ...
    var _b = (0, dnd_1.useFileEntryDnD)(file), drop = _b.drop, drag = _b.drag, dndState = _b.dndState;
...
exports.useStyles = (0, styles_1.makeLocalChonkyStyles)(function (theme) { return ({
    fillParent: {
        height: '100%',
    },
}); });
