...
exports.ToolbarInfo = react_1.default.memo(function () {
    ...
    var selectionSize = (0, react_redux_1.useSelector)(selectors_1.selectSelectionSize);
    var hiddenCount = (0, react_redux_1.useSelector)(selectors_1.selectHiddenFileCount);
    var intl = (0, react_intl_1.useIntl)();
    var fileCountString = intl.formatMessage({
        id: (0, i18n_1.getI18nId)(i18n_1.I18nNamespace.Toolbar, 'visibleFileCount'),
        defaultMessage: "{fileCount, plural,\n                =0 {# items}\n                one {# item}\n                other {# items}\n            }",
    }, { fileCount: displayFileIds.length });
    var selectedString = intl.formatMessage({
        id: (0, i18n_1.getI18nId)(i18n_1.I18nNamespace.Toolbar, 'selectedFileCount'),
        defaultMessage: "{fileCount, plural,\n                =0 {}\n                other {# selected}\n            }",
    }, { fileCount: selectionSize });
    var hiddenString = intl.formatMessage({
        id: (0, i18n_1.getI18nId)(i18n_1.I18nNamespace.Toolbar, 'hiddenFileCount'),
        defaultMessage: "{fileCount, plural,\n                =0 {}\n                other {# hidden}\n            }",
...
var useStyles = (0, styles_1.makeGlobalChonkyStyles)(function (theme) { return ({
    ...
    infoText: {
        lineHeight: (0, styles_1.important)(theme.toolbar.lineHeight),
        fontSize: (0, styles_1.important)(theme.toolbar.fontSize),
        marginLeft: (0, styles_1.important)(12),
        height: theme.toolbar.size,
    },
    extraInfoSpan: {
        marginRight: (0, styles_1.important)(8),
        marginLeft: (0, styles_1.important)(8),
        opacity: 0.8,
    },
    selectionSizeText: {
