...
var ChonkyPresentationLayer = function (_a) {
    var children = _a.children;
    var dispatch = (0, react_redux_1.useDispatch)();
    var fileActionIds = (0, react_redux_1.useSelector)(selectors_1.selectFileActionIds);
    var dndDisabled = (0, react_redux_1.useSelector)(selectors_1.selectIsDnDDisabled);
    var clearSelectionOnOutsideClick = (0, react_redux_1.useSelector)(selectors_1.selectClearSelectionOnOutsideClick);
    // Deal with clicks outside of Chonky
    var handleClickAway = (0, react_1.useCallback)(function (event) {
        if (!clearSelectionOnOutsideClick || (0, helpers_1.elementIsInsideButton)(event.target)) {
    ...
    var hotkeyListenerComponents = (0, react_1.useMemo)(function () {
        return fileActionIds.map(function (actionId) { return (react_1.default.createElement(HotkeyListener_1.HotkeyListener, { key: "file-action-listener-".concat(actionId), fileActionId: actionId })); });
    }, [fileActionIds]);
    var dndContextAvailable = (0, dnd_fallback_1.useDndContextAvailable)();
    var showContextMenu = (0, FileContextMenu_hooks_1.useContextMenuTrigger)();
...
exports.ChonkyPresentationLayer = ChonkyPresentationLayer;
