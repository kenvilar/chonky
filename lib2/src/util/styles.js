...
var useIsMobileBreakpoint = function () {
    return (0, useMediaQuery_1.default)('(max-width:480px)');
};
exports.useIsMobileBreakpoint = useIsMobileBreakpoint;
var getStripeGradient = function (colorOne, colorTwo) {
    return 'repeating-linear-gradient(' +
        '45deg,' +
        "".concat(colorOne, ",") +
        "".concat(colorOne, " 10px,") +
        "".concat(colorTwo, " 0,") +
        "".concat(colorTwo, " 20px") +
        ')';
};
exports.getStripeGradient = getStripeGradient;
var makeLocalChonkyStyles = function (styles) { return (0, react_jss_1.createUseStyles)(styles); };
exports.makeLocalChonkyStyles = makeLocalChonkyStyles;
var makeGlobalChonkyStyles = function (makeStyles) {
    var selectorMapping = {};
    var makeGlobalStyles = function (theme) {
        ...
        localSelectors.map(function (localSelector) {
            var globalSelector = "chonky-".concat(localSelector);
            var jssSelector = "@global .".concat(globalSelector);
            globalStyles[jssSelector] = localStyles[localSelector];
            selectorMapping[localSelector] = globalSelector;
        });
        return globalStyles;
    };
    var useStyles = (0, react_jss_1.createUseStyles)(makeGlobalStyles);
    return function () {
        var args = [];
...
var important = function (value) { return [value, '!important']; };
