...
var thunkUpdateRawFolderChain = function (rawFolderChain) { return function (dispatch, getState) {
    if (getState().rawFolderChain === rawFolderChain)
        return;
    var _a = (0, files_transforms_1.sanitizeInputArray)('folderChain', rawFolderChain), sanitizedArray = _a.sanitizedArray, errorMessages = _a.errorMessages;
...
var thunkUpdateRawFiles = function (rawFiles) { return function (dispatch, getState) {
    if (getState().rawFiles === rawFiles)
        return;
    var _a = (0, files_transforms_1.sanitizeInputArray)('files', rawFiles), sanitizedArray = _a.sanitizedArray, errorMessages = _a.errorMessages;
    ...
    dispatch((0, exports.thunkSortFiles)());
    dispatch((0, exports.thunkUpdateHiddenFiles)());
    dispatch((0, exports.thunkUpdateDisplayFiles)());
...
var thunkSortFiles = function () { return function (dispatch, getState) {
    ...
    if (sortFunctions.length > 0) {
        ...
        var sortedFileIds = (0, fast_sort_1.default)(__spreadArray([], fileIds, true)).by(sortFunctions);
...
var thunkUpdateHiddenFiles = function () { return function (dispatch, getState, _a) {
    ...
    var state = getState();
    var showHiddenFiles = (0, selectors_1.selectOptionValue)(index_1.ChonkyActions.ToggleHiddenFiles.option.id)(state);
    var searchString = (0, selectors_1.selectSearchString)(state);
    ...
    var cleanFileIds = (0, selectors_1.selectCleanFileIds)(state);
    var fileMap = (0, selectors_1.selectFileMap)(state);
...
var thunkUpdateSearchString = function (searchString) { return function (dispatch, getState) {
    var currentSearchString = (0, selectors_1.selectSearchString)(getState());
