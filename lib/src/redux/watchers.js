...
var useStoreWatchers = function (store) {
    (0, react_1.useEffect)(function () {
        var selectionWatcher = (0, redux_watch_1.default)(function () { return (0, selectors_1.selectSelectionMap)(store.getState()); });
        var onSelectionChange = function (newSelection, oldSelection) {
            ...
            var selectedFilesIds = (0, selectors_1.selectSelectedFileIds)(store.getState());
            var selection = new Set(selectedFilesIds);
            store.dispatch((0, dispatchers_thunks_1.thunkRequestFileAction)(action_definitions_1.ChonkyActions.ChangeSelection, {
                selection: selection,
            }));
        };
        var displayFileIdsWatcher = (0, redux_watch_1.default)(function () {
            return (0, selectors_1.selectDisplayFileIds)(store.getState());
        });
        var onDisplayFileIdsChange = function (oldDisplayFileIds, newDisplayFileIds) {
            var oldLastClickIndex = (0, selectors_1.selectLastClickIndex)(store.getState());
...
exports.useStoreWatchers = useStoreWatchers;
