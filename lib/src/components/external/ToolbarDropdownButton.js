...
var useStyles = (0, styles_1.makeGlobalChonkyStyles)(function (theme) { return ({
    baseButton: {
        ...
        height: (0, styles_1.important)(theme.toolbar.size),
        minHeight: (0, styles_1.important)('auto'),
        minWidth: (0, styles_1.important)('auto'),
        padding: (0, styles_1.important)(20),
    },
    icon: {
        fontSize: (0, styles_1.important)(theme.toolbar.fontSize),
        minWidth: (0, styles_1.important)('auto'),
        color: (0, styles_1.important)('inherit'),
        marginRight: 8,
    },
    text: {
        fontSize: (0, styles_1.important)(theme.toolbar.fontSize),
...
exports.SmartToolbarDropdownButton = react_1.default.forwardRef(function (props, ref) {
    ...
    var buttonName = (0, i18n_1.useLocalizedFileActionStrings)(action).buttonName;
