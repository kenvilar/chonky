...
exports.FileBrowser = react_1.default.forwardRef(function (props, ref) {
    ...
    var disableDragAndDrop = (0, helpers_1.getValueOrFallback)(props.disableDragAndDrop, default_config_1.defaultConfig.disableDragAndDrop, 'boolean');
    var disableDragAndDropProvider = (0, helpers_1.getValueOrFallback)(props.disableDragAndDropProvider, default_config_1.defaultConfig.disableDragAndDropProvider, 'boolean');
    var darkMode = (0, helpers_1.getValueOrFallback)(props.darkMode, default_config_1.defaultConfig.darkMode, 'boolean');
    var i18n = (0, helpers_1.getValueOrFallback)(props.i18n, default_config_1.defaultConfig.i18n);
    var formatters = (0, react_1.useMemo)(function () { return (__assign(__assign({}, i18n_1.defaultFormatters), i18n === null || i18n === void 0 ? void 0 : i18n.formatters)); }, [
        i18n,
    ]);
    var chonkyInstanceId = (0, hooks_helpers_1.useStaticValue)(function () { return instanceId !== null && instanceId !== void 0 ? instanceId : shortid_1.default.generate(); });
    var store = (0, store_1.useChonkyStore)(chonkyInstanceId);
    var isMobileBreakpoint = (0, styles_2.useIsMobileBreakpoint)();
    var theme = (0, react_1.useMemo)(function () {
        var muiTheme = (0, styles_1.createMuiTheme)({
            palette: { type: darkMode ? 'dark' : 'light' },
        });
        var combinedTheme = (0, deepmerge_1.default)(muiTheme, (0, deepmerge_1.default)(styles_2.lightTheme, darkMode ? styles_2.darkThemeOverride : {}));
        return isMobileBreakpoint
            ? (0, deepmerge_1.default)(combinedTheme, styles_2.mobileThemeOverride)
            : combinedTheme;
