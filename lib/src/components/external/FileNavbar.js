...
exports.FileNavbar = react_1.default.memo(function () {
    ...
    var folderChainItems = (0, FileNavbar_hooks_1.useFolderChainItems)();
    var folderChainComponents = (0, react_1.useMemo)(function () {
        var components = [];
        for (var i = 0; i < folderChainItems.length; ++i) {
            var key = "folder-chain-".concat(i);
...
var useStyles = (0, styles_1.makeGlobalChonkyStyles)(function (theme) { return ({
    ...
    separator: {
        marginRight: (0, styles_1.important)(4),
        marginLeft: (0, styles_1.important)(4),
    },
}); });
