...
var useFileEntryHtmlProps = function (file) {
...
exports.useFileEntryHtmlProps = useFileEntryHtmlProps;
var useFileEntryState = function (file, selected, focused) {
    var iconData = (0, icon_helper_1.useIconData)(file);
    var _a = (0, exports.useThumbnailUrl)(file), thumbnailUrl = _a.thumbnailUrl, thumbnailLoading = _a.thumbnailLoading;
    return (0, react_1.useMemo)(function () {
...
exports.useFileEntryState = useFileEntryState;
var useDndIcon = function (dndState) {
...
exports.useDndIcon = useDndIcon;
var useModifierIconComponents = function (file) {
    var modifierIcons = (0, react_1.useMemo)(function () {
        var modifierIcons = [];
    ...
    var modifierIconComponents = (0, react_1.useMemo)(function () {
        return modifierIcons.map(function (icon, index) { return (react_1.default.createElement(ChonkyIcon, { key: "file-modifier-".concat(index), icon: icon })); });
    }, 
...
exports.useModifierIconComponents = useModifierIconComponents;
var useFileNameComponent = function (file) {
    return (0, react_1.useMemo)(function () {
        var _a;
        if (!file)
...
exports.useFileNameComponent = useFileNameComponent;
var useThumbnailUrl = function (file) {
    var thumbnailGenerator = (0, react_redux_1.useSelector)(selectors_1.selectThumbnailGenerator);
    var _a = (0, react_1.useState)(null), thumbnailUrl = _a[0], setThumbnailUrl = _a[1];
    var _b = (0, react_1.useState)(false), thumbnailLoading = _b[0], setThumbnailLoading = _b[1];
        ...
        if (file) {
            if (thumbnailGenerator) {
                ...
                Promise.resolve()
                    ...
                    if (!loadingCancelled)
                        setThumbnailLoading(false);
                    logger_1.Logger.error("User-defined \"thumbnailGenerator\" handler threw an error: ".concat(error.message));
                });
            }
...
exports.useThumbnailUrl = useThumbnailUrl;
var useFileClickHandlers = function (file, displayIndex) {
    var dispatch = (0, react_redux_1.useDispatch)();
    // Prepare base handlers
    var onMouseClick = (0, react_1.useCallback)(function (event, clickType) {
        if (!file)
            return;
        dispatch((0, dispatchers_thunks_1.thunkRequestFileAction)(index_1.ChonkyActions.MouseClickFile, {
            clickType: clickType,
            file: file,
    ...
    var onKeyboardClick = (0, react_1.useCallback)(function (event) {
        if (!file)
            return;
        dispatch((0, dispatchers_thunks_1.thunkRequestFileAction)(index_1.ChonkyActions.KeyboardClickFile, {
            file: file,
            fileDisplayIndex: displayIndex,
    ...
    var onSingleClick = (0, react_1.useCallback)(function (event) { return onMouseClick(event, 'single'); }, [onMouseClick]);
    var onDoubleClick = (0, react_1.useCallback)(function (event) { return onMouseClick(event, 'double'); }, [onMouseClick]);
    return {
...
exports.useFileClickHandlers = useFileClickHandlers;
