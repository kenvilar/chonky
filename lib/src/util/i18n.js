...
var getI18nId = function (namespace, stringId) {
    return "chonky.".concat(namespace, ".").concat(stringId);
};
exports.getI18nId = getI18nId;
var getActionI18nId = function (actionId, stringId) {
    return "chonky.".concat(I18nNamespace.FileActions, ".").concat(actionId, ".").concat(stringId);
};
...
var useLocalizedFileActionGroup = function (groupName) {
    ...
    return (0, react_1.useMemo)(function () {
        return intl.formatMessage({
            id: (0, exports.getI18nId)(I18nNamespace.FileActionGroups, groupName),
...
var useLocalizedFileActionStrings = function (action) {
    ...
    return (0, react_1.useMemo)(function () {
        ...
        var buttonName = intl.formatMessage({
            id: (0, exports.getActionI18nId)(action.id, 'button.name'),
        ...
        if ((_b = action.button) === null || _b === void 0 ? void 0 : _b.tooltip) {
            ...
            buttonTooltip = intl.formatMessage({
                id: (0, exports.getActionI18nId)(action.id, 'button.tooltip'),
...
var useLocalizedFileEntryStrings = function (file) {
    var intl = (0, react_intl_1.useIntl)();
    var formatters = (0, react_1.useContext)(exports.ChonkyFormattersContext);
    return (0, react_1.useMemo)(function () {
        return {
...
exports.defaultFormatters = {
    ...
    formatFileSize: function (intl, file) {
        if (!file || typeof file.size !== 'number')
            return null;
        var size = file.size;
        var sizeData = (0, filesize_1.default)(size, { bits: false, output: 'object' });
        if (sizeData.symbol === 'B') {
            return "".concat(Math.round(sizeData.value / 10) / 100.0, " KB");
        }
        else if (sizeData.symbol === 'KB') {
            return "".concat(Math.round(sizeData.value), " ").concat(sizeData.symbol);
        }
        return "".concat(sizeData.value, " ").concat(sizeData.symbol);
    },
};
exports.ChonkyFormattersContext = (0, react_1.createContext)(exports.defaultFormatters);
