...
var useDndContextAvailable = function () {
    var dndContext = (0, react_1.useContext)(react_dnd_1.DndContext);
...
var useDragIfAvailable = function () {
    ...
    var dndContextAvailable = (0, exports.useDndContextAvailable)();
    var mockHook = (0, react_1.useCallback)(function () { return [{}, function () { return null; }, function () { return null; }]; }, []);
    // @ts-ignore
...
var useDropIfAvailable = function () {
    ...
    var dndContextAvailable = (0, exports.useDndContextAvailable)();
    var mockHook = (0, react_1.useCallback)(function () { return [{}, function () { return null; }]; }, []);
    // @ts-ignore
