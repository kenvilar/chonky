...
export declare const makeLocalChonkyStyles: <C extends string = string>(styles: (theme: ChonkyTheme & MuiTheme) => Record<C, string | import("jss").JssStyle | ((data: any) => string | import("jss").JssStyle | null | undefined)>) => (data?: unknown) => Record<C, string>;
export declare const makeGlobalChonkyStyles: <C extends string = string>(makeStyles: (theme: ChonkyTheme & MuiTheme) => Record<C, string | import("jss").JssStyle | ((data: any) => string | import("jss").JssStyle | null | undefined)>) => (...args: any[]) => Record<C, string>;
export declare const important: <T>(value: T) => (string | T)[];
export declare const c: import("classnames/types").ClassNamesExport;
