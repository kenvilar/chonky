...
exports.useFileDrag = function (file) {
...
exports.useFileDrop = function (_a) {
    ...
    var canDrop = react_1.useCallback(function (item, monitor) {
        ...
        var movedFiles = __spreadArrays([draggedFile], selectedFiles);
...
exports.useFileEntryDnD = function (file) {
...
exports.useDndHoverOpen = function (file, dndState) {
    var dispatch = react_redux_1.useDispatch();
