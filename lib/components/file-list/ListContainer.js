...
exports.ListContainer = react_1.default.memo(function (props) {
    ...
    var getItemKey = react_1.useCallback(function (index) { var _a; return (_a = displayFileIdsRef.current[index]) !== null && _a !== void 0 ? _a : "loading-file-" + index; }, [displayFileIdsRef]);
    var classes = useStyles();
    var listComponent = react_1.useMemo(function () {
