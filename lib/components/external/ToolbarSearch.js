...
exports.ToolbarSearch = react_1.default.memo(function () {
    ...
    return (react_1.default.createElement(TextField_1.default, { className: classes.searchFieldContainer, size: "small", variant: "outlined", value: localSearchString, placeholder: searchPlaceholderString, onChange: handleChange, onBlur: function (e) {
