...
var ClickableWrapper = function (props) {
    ...
    var compProps = {
        onFocus: react_1.useCallback(function () { return setFocused && setFocused(true); }, [setFocused]),
        onBlur: react_1.useCallback(function () { return setFocused && setFocused(false); }, [setFocused]),
    };
